...
<div id="booking" class="section">
    <div class="section-center">
        <h3>WELCOME: <?php echo isset($_SESSION['name']) ? $_SESSION['name'] : 'Guest'; ?></h3>
        <div class="container">
            <div class="row">
...
<div id="successModal" class="modal">
    <div class="modal-content">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h5>A refundable charge of N5,000 is to be added to your total payment. Please call the Reservation No</h5><br>
                <h6>Booking ID: <?php echo htmlspecialchars($_GET['booking_id']); ?></h6>
            </div>
        </div>
    </div>
</div>
